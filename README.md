        ...
        <nav id="scrollingNav">
          <ul class="sidenav nav nav-list">
            ...
            <li class="nav-fixed nav-header active" data-group="_"><a href="#api-_">API Summary</a></li>
                  ...
                  <li class="nav-header" data-group="Products"><a href="#api-Products">API Methods - Products</a></li>
                    <li data-group="Products" data-name="productsGet" class="">
                      <a href="#api-Products-productsGet">productsGet</a>
                    </li>
          </ul>
        </nav>
      </div>
...
| cell1   | cell2    |</p>
        ...
        <div id="sections">
                <section id="api-Products">
                  <h1>Products</h1>
                    <div id="api-Products-productsGet">
                      <article id="api-Products-productsGet-0" data-group="User" data-name="productsGet" data-version="0">
                        <div class="pull-left">
                          <h1>productsGet</h1>
                          <p>Product Types</p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">The Products endpoint returns information about the *Uber* products
...
proper display order.
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/products</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Products-productsGet-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Products-productsGet-0-java">Java</a></li>
                          <li class=""><a href="#examples-Products-productsGet-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Products-productsGet-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Products-productsGet-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Products-productsGet-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Products-productsGet-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Products-productsGet-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Products-productsGet-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Products-productsGet-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Products-productsGet-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Products-productsGet-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://localhost/products?latitude=&longitude="</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Products-productsGet-0-java">
...
public class ProductsApiExample {
    ...
    public static void main(String[] args) {
        ...
        Double latitude = 1.2; // Double | Latitude component of location.
        Double longitude = 1.2; // Double | Longitude component of location.
        try {
            apiInstance.productsGet(latitude, longitude);
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-Products-productsGet-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.ProductsApi;
...
public class ProductsApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Products-productsGet-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Products-productsGet-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Double *latitude = 1.2; // Latitude component of location.
Double *longitude = 1.2; // Longitude component of location.

ProductsApi *apiInstance = [[ProductsApi alloc] init];

// Product Types
[apiInstance productsGetWith:latitude
    longitude:longitude
              completionHandler: ^(NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-Products-productsGet-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var IntroductionToApi = require('introduction_to_api');

var api = new IntroductionToApi.ProductsApi()

var latitude = 1.2; // {Double} Latitude component of location.

var longitude = 1.2; // {Double} Longitude component of location.
...
api.productsGet(latitude, longitude, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Products-productsGet-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Products-productsGet-0-csharp">
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling ProductsApi.productsGet: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-Products-productsGet-0-php">
...
try {
    $api_instance->productsGet($latitude, $longitude);
} catch (Exception $e) {
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-Products-productsGet-0-perl">
...
eval { 
    $api_instance->productsGet(latitude => $latitude, longitude => $longitude);
};
if ($@) {
    warn "Exception when calling ProductsApi->productsGet: $@\n";
                            ...
                            <div class="tab-pane" id="examples-Products-productsGet-0-python">
...
try: 
    # Product Types
    api_instance.products_get(latitude, longitude)
                          ...
                          <h2>Parameters</h2>
                            ...
                            <table id="methodsubtable">
                              <tr>
                                ...
                                <tr><td style="width:150px;">latitude*</td>
<td>


    <div id="d2e199_productsGet_latitude">
            ...
            <div class="primitive">
                ...
                <div class="inner required">
                    Required
                                ...
                                <tr><td style="width:150px;">longitude*</td>
<td>


    <div id="d2e199_productsGet_longitude">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    Double
                ...
                <div class="inner required">
                    Required
                          ...
                          <h2>Responses</h2>
                            <h3> Status: 200 - An array of products </h3>
          ...
          <div id="generator">
            <div class="content">
              Generated 2018-05-15T08:09:05.755Z
            </div>
          </div>
      </div>
    </div>
